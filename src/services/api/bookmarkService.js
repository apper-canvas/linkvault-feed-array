...
folderId: bookmark.folder_id_c?.Id || bookmark.folder_id_c,
        isPinned: bookmark.is_pinned_c || false
      }));
    } catch (error) {
...
folder_id_c: bookmarkData.folderId ? parseInt(bookmarkData.folderId) : null,
          is_pinned_c: bookmarkData.isPinned || false
        }]
      };
...
favicon: created.favicon_c,
            ...
            isPinned: created.is_pinned_c || false,
...
folder_id_c: bookmarkData.folderId ? parseInt(bookmarkData.folderId) : null,
          is_pinned_c: bookmarkData.isPinned !== undefined ? bookmarkData.isPinned : false
        }]
      };
...
dateAdded: updated.date_added_c,
            ...
            isPinned: updated.is_pinned_c || false,
  ...
  async getPinned() {
    ...
    try {
      const params = {
        ...
        where: [{"FieldName": "is_pinned_c", "Operator": "EqualTo", "Values": [true]}],
        orderBy: [{"fieldName": "date_added_c", "sorttype": "DESC"}],
        pagingInfo: {"limit": 100, "offset": 0}
      };
